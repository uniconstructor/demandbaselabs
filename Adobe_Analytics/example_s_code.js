/*
 *  This is a sample file to show where to place the Demandbase plugin and Integrate module.
 *
 *  Do not use the plugin (or other code) in this file!!!
 *
 *  You must configure and generate your plugin using the Adobe Data Connector
 *
 *  See: [complete deployment guide](http://microsite.omniture.com/t2/help/en_US/connectors/demandbase/#Deploying_the_Integration)
 */
...
var s_account="yourreportsuites"
...
function s_doPlugins(s) {
    ...
    //Do NOT place Demandbase plugin or integrat module within the s_doPlugins function!
...
/*
    Other customization code here....
 */

/* PLUGINS */

/***
    Begin Demandbase Data Connector v2.1.1
***/
s.maxDelay=750
...
s.Integrate.onLoad=function(s,m){
  ...
  /*
   * [Begin] Partner Plugin: Demandbase v2.1.1 im
   */
    s.Integrate.add("Demandbase");
    var _db = s.Integrate.Demandbase;
    _db._key="YOUR_KEY_HERE";
    ...
    _db._dimensionArrayCustom=[
        ...
        {"id":"watch_list_your_field_here","max_size":30},
        {"id":"watch_list_crm_system","max_size":30},
        {"id":"b2b","max_size":30},
        {"id":"b2c","max_size":30},
        {"id":"forbes_2000","max_size":30},
...
s.visitorNamespace="yourStuffHere"
s.trackingServer="yourStuffHere"
