...
Demandbase.Connectors.Webtrends_Analytics={
    ...
    track:function(data) {
      try {
        ...
        self.dbDataSet = data;  /*allows access to db dataset in JS outside of this namespace */
    ...
    dcsJSONTrack=function(jperm) {
        ...
        if (typeof(dcsMultiTrack)!="undefined") {
            Args.push('WT.dl','5','WT.ti','DemandBase Data Collection','DCS.dcsuri','demandbase-data-collection.dbc'); //It appears that we do not need to URI encode the WT.ti value
