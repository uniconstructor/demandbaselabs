        ...
        <?php endif; ?>
            ...
            <form name="demandbase_settings_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
                ...
                <p>
                    ...
                    You must enter your Demandbase Content Module key.
                </p>
                ...
                <div id="demandbase_sim_active_wrapper">
                    ...
                    <p id="db_company_ip_toggle">
                        ...
                        <select id="demandbase_company_ip" name="demandbase_company_ip">
                            ...
                            <option value="207.123.128.73"   <?php echo ($db_settings['test_company_ip'] == '212.125.84.152') ? 'selected="selected"' : '' ?>>U.S. General Services (Government => Administration)</option>
                        ...
                        Select a company to simulate or enter an IP.
                    </p>
                    ...
                    <div id="demandbase_custom_ip_wrapper">
                        ...
                        <p>
                            ...
                            Enter an IP here to simulate a specific IP address.
                        </p>
