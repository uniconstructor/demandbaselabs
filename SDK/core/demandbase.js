/**
    ...
    License: Copyright 2013. This code may not be reused without
    explicit permission by its owners. All rights reserved.

    TOC:
        1. jQuery (nested/minfied)
        2. Demandbase Company Autocomplete Widget (minified)
        3. Demandbase.utils
        4. Demandbase.IP
        5. Demandbae.Domain
        6. Demandbase Audience Builder Helper Classes
        7. Demandbase.Segments
...
/** !!!!!!!!! DO NOT MODIFY ANYTHING ABOVE THIS LINES !!!!!!!!!!!! **/
...
//TODO: _dbc may be replaced by 'demandbase' function call
...
/**
    Class: DBSegment
    Combines conditions using boolean ops, evaluates a group
**/
...
/**
    Class: DBContent
    Builder Class for DBCondition
    TODO: build out functionality of this class, if needed
*
...
Demandbase.Segments = {
    ...
    _debug: true,
    Conditions: {
        //TODO: RHS could be an object: {attribute: '', operator: '', value: '' || []}
    ...
    _setup: function() {
        ...
        for (var cond in this.Conditions) {
            ...
            //TODO: use domain company profile, if available
            this.Conditions[cond][0] = Demandbase.IP.CompanyProfile[this.Conditions[cond][0]];
            //replaces array with DBCondition object
            this.Conditions[cond] = DBConditionBuilder.build(cond, this.Conditions[cond]);
        }
    ...
    //TODO: optionally define additional public properties
    //activeSegments: null,     //all segments (names) which return true for a visitor
